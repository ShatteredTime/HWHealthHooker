...
internal object HealthMetaDataDbHooker :
    ...
    private val cached = Memo<DbMetadataSnapshot>()

    override val providedApi: HealthMetadataDbApi =
        object : HealthMetadataDbApi, MetadataSourceApi by availability {
            override fun snapshot() = cached.orCatching {
